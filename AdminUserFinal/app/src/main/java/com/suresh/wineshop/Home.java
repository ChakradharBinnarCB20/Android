...
public class Home extends AppCompatActivity {
    ...
    String con_ipaddress ,portnumber,user_name,m_comp_desc,password,mob,db;
    int m_comp_code;
    String IMEINumber;
    ...
    public void selectDrawerItem(MenuItem menuItem){
        ...
        if (id==R.id.home){
            ...
            fragmentClass = Closing_Stock__Fragment.class;

        } else if (id==R.id.item_stock) {
            fragmentClass = Item_Wise_Stock_whitin_peroid_Fragment.class;

        } else if (id==R.id.cust_wise_summary) {
            fragmentClass = Customer_Wise_Summary_Fragment.class;

        } else if (id==R.id.sale_register) {
            fragmentClass = Sale_Register_Fragment.class;
        ...
        } else if (id==R.id.date_brand_wise_sale_report) {
        ...
        }else if (id==R.id.suplier_wise_brand_wise_pur_reg) {
            fragmentClass = Supplier_Wise_Brand_Wise_Pur_Reg.class;

        }else if (id==R.id.customer_wise_item_wise_sale) {
            fragmentClass = Customer_Wise_Item_Wise_Sale_Fragment.class;

        }else if (id==R.id.stock_val) {
            fragmentClass = Stock_Val_Fragment.class;

        }else if (id==R.id.profit_loss) {
            fragmentClass = Profit_Loss_Statement_Fragment.class;
        }else {
...
//                fragmentClass = Date_Wise_Cash_Withdrawal_Fragment.class;
//                break;
//            case R.id.suplier_wise_brand_wise_pur_reg:
//                fragmentClass = Supplier_Wise_Brand_Wise_Pur_Reg.class;
//                break;
//            case R.id.customer_wise_item_wise_sale:
//                fragmentClass = Customer_Wise_Item_Wise_Sale_Fragment.class;
//                break;
//            case R.id.stock_val:
//                fragmentClass = Stock_Val_Fragment.class;
//                break;
//            case R.id.profit_loss:
//                fragmentClass = Profit_Loss_Statement_Fragment.class;
//                break;
//            default:
//                fragmentClass = WelcomeFragment.class;
