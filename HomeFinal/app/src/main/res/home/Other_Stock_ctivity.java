...
public class Other_Stock_ctivity extends AppCompatActivity {
    ...
    public class atnds_recyclerAdapter extends RecyclerView.Adapter<Other_Stock_ctivity.atnds_recyclerAdapter.Pex_ViewHolder> {
        Context context;
        ...
        @Override
        public Other_Stock_ctivity.atnds_recyclerAdapter.Pex_ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.other_stock_list_, parent, false);
            Other_Stock_ctivity.atnds_recyclerAdapter.Pex_ViewHolder viewHolder = new atnds_recyclerAdapter.Pex_ViewHolder(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(final Other_Stock_ctivity.atnds_recyclerAdapter.Pex_ViewHolder holder, final int position) {
